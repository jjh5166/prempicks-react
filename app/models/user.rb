class User < ApplicationRecord
  ...
  validates :team_name, uniqueness: {message: "Sorry, this team name is taken"}
  validates :email, uniqueness: {message: "This email already in use"}
  ...
  def password_complexity
    ...
    errors.add :password, 'Password should be at least 8 characters long and include: 1 uppercase, 1 lowercase, 1 digit and 1 special character'
  end
